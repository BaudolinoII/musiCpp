...
namespace filek {
	...
	class scMachine {
		...
		/// Ejemplo -> oEjempl
		/// </summary>
		/// <param name="times">N�mero de reiteraciones del proceso</param>
		...
		/// <summary>
		/// Encripta la contrase�a utilizandose asi misma
		/// </summary>
		/// <param name="key">Apuntador a cadena que contiene la contrase�a, se guarda all� mismo</param>
		...
		/// <summary>
		/// Proceso de encriptaci�n de la palabra
		/// </summary>
		/// <param name="str">Apuntador a cadena que contiene la frase a encriptar, se guarda all� mismo</param>
		...
		/// </summary>
		/// <param name="str">Apuntador a cadena que contiene la frase a desencriptar, se guarda all� mismo</param>
		...
		/// <summary>
		/// Interse una contrase�a al sistema
		/// </summary>
		/// <param name="pwd">Cadena de caracteres para funcionar como contrase�a</param>
		...
		/// <summary>
		/// Proceso de Control para colocar variables est�ticas
		/// </summary>
	...
	/// https://github.com/OneLoneCoder (Trabajo a�n no subido a la fecha)
	/// Cambios a�adidos:
	/// Sistema de Encriptado opcional
	/// Sistema de comentarios removido
	/// Soporte para programar con la llave de apertura '{' al final del rengl�n
	/// </summary>
	class dynamicfile {
		...
		/// <summary>
		/// Soporte para el empleo de arreglos din�micos y anidados
		/// obj["nombre"]["categora"]["subcategoria"] ... 
		/// </summary>
		/// <param name="name">identificador de la categor�a</param>
		...
		/// <summary>
		/// Metodo est�tico para guardar el archivo din�mico en memoria de almacenamiento
		/// </summary>
		/// <param name="df"> apuntador del objeto archivo din�mico</param>
		/// <param name="fileName"> Direcci�n/Nombre con extensi�n del archivo a guardar</param>
		/// <param name="encript">(opcional) Se guardar� encriptado, por defecto no</param>
		...
		/// <summary>
		/// M�todo est�tico para cargar en memoria un archico din�mico
		/// </summary>
		/// <param name="df"> apuntador donde guardar el archivo din�mico</param>
		/// <param name="fileName"> Direcci�n/Nombre con extensi�n del archivo a cargar</param>
		/// <param name="encript">(opcional) Se guard� encriptado, por defecto no</param>
		/// <param name="split">(opcional) Caracter con el que se guard� la separacion de elementos, por defecto ','</param>
